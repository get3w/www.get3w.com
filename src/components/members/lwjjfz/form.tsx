...
export default class LWJJFZ extends React.Component<P, S> {
  ...
  onCalendarSelect(date: Date, e) {
    ...
    this.state.user.toActivistDate = date
    this.setState(this.state);
  }
  ...
  render() {
    ...
    const title = '将' + user.displayName + '列为积极分子'
          ...
          <div className="m2nadBox" style={{ paddingTop: "45px" }}>
            <ul>
              ...
              <li>
                ...
                <input value={utils.Translate.toShortDate(this.state.user.toActivistDate) } onClick={this.onCalendarClick.bind(this) } type="text" className="m2fm_int m2fm_int2 m2fm_int10" style={{ width: "255px" }} name="" />
                {calendarEl}
              </li>
            </ul>
          </div>
