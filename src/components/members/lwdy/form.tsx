...
export default class LWDY extends React.Component<P, S> {
  constructor(props) {
    super(props)
    this.state = {
  ...
  onCalendarSelect(date: Date, e) {
    ...
    this.state.user.toFullmembersDate = date
    this.setState(this.state);
  }
  ...
  render() {
    ...
    const title = '将' + user.displayName + '列为党员'
        ...
        <div className="layerCon1 layerCon3 layerCon3b">
          ...
          <div className="m2nadBox" style={{ paddingTop: "45px" }}>
            <ul>
              ...
              <li>
                <span className="lay_s1" style={{ width: "117px" }}>转正时间</span>
                <input value={utils.Translate.toShortDate(this.state.user.toFullmembersDate) } onClick={this.onCalendarClick.bind(this) } type="text" className="m2fm_int m2fm_int2 m2fm_int10" style={{ width: "255px" }} name="" />
                {calendarEl}
              </li>
            </ul>
          </div>
