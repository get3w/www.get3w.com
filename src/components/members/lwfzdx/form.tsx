...
export default class LWFZDX extends React.Component<P, S> {
  ...
  onCalendarSelect(date: Date, e) {
    ...
    this.state.user.toDevelopmentObDate = date
    this.setState(this.state);
  }
  ...
  render() {
    ...
    const title = '将' + user.displayName + '列为发展对象'
        ...
        <div className="layerCon1 layerCon3 layerCon3b">
          ...
          <div className="m2nadBox" style={{ paddingTop: "45px" }}>
            <ul>
              ...
              <li>
                <span className="lay_s1" style={{ width: "117px" }}>成为发展对象时间</span>
                <input value={utils.Translate.toShortDate(this.state.user.toDevelopmentObDate) } onClick={this.onCalendarClick.bind(this) } type="text" className="m2fm_int m2fm_int2 m2fm_int10" style={{ width: "255px" }} name="" />
                {calendarEl}
              </li>
            </ul>
          </div>
