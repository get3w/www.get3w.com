    ...
    return (
      <div>
        <div className="m2per_u2">
          <ul>
            <li>
              <strong className="m2per_sbnm">政审结果：</strong>
              <div className="m2per_txtInfo">{this.props.record.remarks}</div>
            </li>
            <li>
              <strong className="m2per_sbnm">政审时间：</strong>
              <div className="m2per_txtInfo">{utils.Translate.toShortDate(this.props.record.happenDate) }</div>
            </li>
            <li>
              <strong className="m2per_sbnm">政审材料：</strong>
              <div className="m2per_txtInfo">{fileEl}</div>
            </li>
          </ul>
        </div>
        {editBtnEl}
