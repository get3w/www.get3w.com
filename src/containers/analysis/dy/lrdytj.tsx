          ...
          <table width="100%">
            <tbody>
              <tr className="m2tabs_th m2tabs_th2">
                <td width="22%" rowSpan={2} className="m2tabs_ltd center">组  织 </td>
                <td style={{ borderBottom: '1px solid #fff' }} colSpan={3} className="center">流动地域</td>
                <td width="12%" rowSpan={2} className="m2tabs_rtd center">总 数</td>
              </tr>
              <tr className="m2tabs_th m2tabs_th2">
                <td width="23%" className="center">跨   省</td>
                <td width="23%" className="center">省内跨市</td>
                <td width="20%" className="center">市内跨县</td>
              </tr>
              {listEl}
            </tbody>
          </table>
