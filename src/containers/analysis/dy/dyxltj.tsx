          ...
          <table width="100%">
            <tbody>
              <tr className="m2tabs_th">
                ...
                <td className="center">研究生</td>
                <td className="center">大学本科</td>
                <td className="center">大学专科</td>
                <td className="center">中专</td>
                <td className="center">高中中技</td>
                <td className="center">初中及以下</td>
