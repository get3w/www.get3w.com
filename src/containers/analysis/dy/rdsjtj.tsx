    ...
    let listEl = this.state.results.map((result) => {
      ...
      return (
        <tr key={result.orgID}>
          ...
          <td className="center">{result.count2}</td>
          <td className="center">{result.count3}</td>
          <td className="center">{result.count4}</td>
          <td className="center">{result.count5}</td>
          <td className="center">{result.count6}</td>
          <td className="center">{result.count7}</td>
          <td className="m2tabs_rtd center">{result.total}</td>
        </tr>
      )
    })
          ...
          <table width="100%">
            <tbody>
              <tr className="m2tabs_th">
                ...
                <td className="center">2010-现在</td>
                <td className="center">2001-2010</td>
                <td className="center">1999-2000</td>
                <td className="center">1981-1990</td>
                <td className="center">1971-1980</td>
                <td className="center">1961-1970</td>
                <td className="center">1960年前</td>
