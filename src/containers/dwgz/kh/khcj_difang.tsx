...
class KHCJ extends React.Component<P, S> {
  ...
  load(org: models.Org) {
    client.testExams.searchByUp(true, org.id, this.state.org ? this.state.org.id : 0, this.state.startDate, this.state.endDate, (err: models.Error, res: Array<models.TestExam>) => {
