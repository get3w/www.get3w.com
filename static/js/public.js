...
$(".m2per_u3 li:odd").addClass("m2per_even");

$(".m2tabs tr:last").addClass("m2tabs_lsTr");

/*2016-03-30 JS*/
$(".s_font").click(function(){$(".m2news_editor").css({"font-size":"14px","line-height":"24px"})});
$(".m_font").click(function(){$(".m2news_editor").css({"font-size":"15px","line-height":"26px"})});
$(".b_font").click(function(){$(".m2news_editor").css({"font-size":"16px","line-height":"30px"})});
